...
void Parameters::parse_options(int argc, char* argv[])
{
    ...
    config_add("scheduler-interval-length", po::value<uint32_t>(&scheduler_interval_length_)->default_value(10000),
    ...
    config_add("scheduler-speedup-percentage", po::value<uint32_t>(&scheduler_speedup_percentage_)->default_value(0),
    	       "The scheduler speeding up percentage");
    config_add("scheduler-speedup-interval-count", po::value<uint32_t>(&scheduler_speedup_interval_count_)->default_value(0),
