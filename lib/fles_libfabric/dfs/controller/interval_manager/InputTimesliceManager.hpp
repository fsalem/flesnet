...
public:
  ...
  // Update the load distribution of interval
  void update_load_distribution(uint64_t start_timeslice,
  ...
  bool acknowledge_timeslice_rdma_write(uint64_t interval_index,
  ...
  void log_timeslice_IB_blocked(uint64_t interval,
                                uint32_t compute_index,
                                uint64_t timeslice,
                                bool sent_completed = false);

  void log_timeslice_CB_blocked(uint64_t interval,
                                uint32_t compute_index,
                                uint64_t timeslice,
                                bool sent_completed = false);

  void log_timeslice_MR_blocked(uint64_t interval,
                                uint32_t compute_index,
                                uint64_t timeslice,
                                bool sent_completed = false);
