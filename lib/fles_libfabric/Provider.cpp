...
void dump_fi_info(const struct fi_info *info) {
	...
	fprintf(stdout, "\t addr_format %du\n",info->addr_format);

	/*/////////////// ep_attr ////////////////////////////// */
	fprintf(stdout, "\t\t ep_attr->auth_key %du\n",info->ep_attr->auth_key);
	...
	fprintf(stdout, "\t\t domain_attr->data_progress %du\n",info->domain_attr->data_progress);
