...
private:
    ...
    // The number of virtual compute connections according to scheduler
    // frequency
    ...
    SizedMap<uint32_t, SizedMap<uint64_t, TimesliceInfo*>*>
        conn_timeslice_info_;
    ...
    SizedMap<uint64_t, std::vector<std::set<uint64_t>*>>
        to_be_moved_timeslices_;
